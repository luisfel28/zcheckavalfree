		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Verificação de Avaliações p/ Contrato",
									"targetURL": "#comfidelidademundialzcheckavalfree-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comfidelidademundialzcheckavalfree-display": {
								"semanticObject": "comfidelidademundialzcheckavalfree",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.fidelidademundial.zcheckavalfree",
									"url": sap.ui.require.toUrl("com/fidelidademundial/zcheckavalfree")
								}
							}
						}
					}
